...
class Cooking(Predicate):
    def __init__(self, obj, start_time=None):
        Predicate.__init__(self, 'Cooking', (obj,), start_time=start_time, time_limit=COOKING_TIME_SECONDS)
...
##----------------------------------------------
class Grill(Predicate):
    def __init__(self, obj, start_time=None):
        Predicate.__init__(self, 'Grill', (obj,), start_time=start_time, time_limit=COOKED_BEFORE_FIRE_TIME_SECONDS)
        self._rest_steps = COOKED_BEFORE_FIRE_TIME_SECONDS
...
class Burn(Predicate):
    def __init__(self, obj, **kwargs):
        Predicate.__init__(self, 'Burn', (obj,))
        self._rest_steps = 1e9
##----------------------------------------------
